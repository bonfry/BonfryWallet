        ...
        .then((externalDir) async{
          _externalDir = externalDir;
           settingsPreferences = await SharedPreferences.getInstance();
            String backupPath = settingsPreferences.getString(SettingConstraints.BACKUP_SETTING_NAME);
            
            if(backupPath == null){
              backupPath = '${externalDir.path}/BonfryWalletBackup';
              await settingsPreferences.setString(SettingConstraints.BACKUP_SETTING_NAME, backupPath);
            }
        ...
        children: <OptionElement>[
                    ...
                    builder: (BuildContext context) {
                      return FolderPickerPage(
                          ...
                          action: (BuildContext context, Directory newDir) async{
                            await settingsPreferences.setString(SettingConstraints.BACKUP_SETTING_NAME, newDir.path);
          ...
          OptionElement(
              ...
              callback:(context){
                ...
                DatabaseManager.backupDatabaseToJson().then((jsonText) =>
                  backupFile.writeAsString(jsonText)
          ...
          OptionElement(
              ...
              .then((String text) => DatabaseManager.restoreDatabaseFromJson(text))
              .then((_){
                Scaffold.of(context)
                    .showSnackBar(SnackBar(content: Text("Backup ripristinato"),));
              })
          ),
        ],
      ),
