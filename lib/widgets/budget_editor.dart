...
class BudgetEditor extends StatefulWidget{
  ...
  @override
  BudgetEditorState createState() => BudgetEditorState(currentBudget: currentBudget);
}
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                Container(
                  padding: EdgeInsets.only(right: currentBudget.id == null ? 12:0),
                  child: RaisedButton(
                    child:Text("Salva"),
                ...
                Visibility(
                  ...
                  child: PopupMenuButton<int>(
                    onSelected: (value) async{
                      switch (value){
                        case 0: 
                          await removeMoneyBudget(this.currentBudget.id);
                          return Navigator.pop(context,BudgetEditorResponse(BudgetEditorResponseType.removed));
                      }
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border: currentBudget.color == null ? Border.all(): null,
...
Future<BudgetEditorResponse> showBudgetEditor(context,{MoneyBudget budget}) async{
  var modalResponse = await showModalBottomSheetApp<BudgetEditorResponse>(
      context: context,
      builder: (context) =>
        BudgetEditor(currentBudget: budget)
    );

  return modalResponse ?? BudgetEditorResponse(BudgetEditorResponseType.aborted);
}
